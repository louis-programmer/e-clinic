...
<div class="card" style="margin-top:20px;">
    ...
    ">
        ...
        ">
            Total:
            <strong>{{ $upcomingAppointments->total() }}</strong>
        </div>
    ...
    @if($upcomingAppointments->hasPages())
        ...
        ">
            ...
            @else
                ...
                <a href="{{ $upcomingAppointments->previousPageUrl() }}#appointments"
                   style="
                        padding:6px 12px;
                        background:#f1f5f9;
                        border-radius:6px;
            ...
            @if($upcomingAppointments->hasMorePages())
                ...
                <a href="{{ $upcomingAppointments->nextPageUrl() }}#appointments"
                   style="
                        padding:6px 12px;
                        background:#f1f5f9;
                        border-radius:6px;
    ...
    @forelse($upcomingAppointments as $appointment)
        ...
        @php
            ...
            $canManage = auth()->user()
                ->hasAnyRole(...config('roles.patient_manage'));
...
<div class="card" style="margin-top:20px;">
    ...
    ">
        ...
        ">
            Total:
            <strong>{{ $previousAppointments->total() }}</strong>
        </div>
    ...
    @if($previousAppointments->hasPages())
        ...
        ">
            ...
            @else
                ...
                <a href="{{ $previousAppointments->previousPageUrl() }}#appointments"
                   style="
                        padding:6px 12px;
                        background:#f1f5f9;
                        border-radius:6px;
            ...
            @if($previousAppointments->hasMorePages())
                ...
                <a href="{{ $previousAppointments->nextPageUrl() }}#appointments"
                   style="
                        padding:6px 12px;
                        background:#f1f5f9;
                        border-radius:6px;
